...
def _pushed_sha(root: Path, branch: str) -> str | None:
...
def delivery_receipt(project_dir: str | Path) -> DeliveryReceipt | None:
    ...
    try:
        ...
        pushed_sha = _pushed_sha(root, branch)
        pr = integration.pr_for_branch(root, branch)
