---
status: active
current_focus: "2026-08-12 — The seven-phase topics migration merged in #506 (`9ee4e53`): free-form topics now drive backlog tree, TUI Direction, consolidate standings, and generated Vision directions; the facet/explore-phase/vision-branch apparatus and coupled skills are retired; 18 parked branch cards are archived. Required pytest 3.12/3.13, freshness, acceptance greps, and live probes were green on exact head `219726e`."
next_action: "Return to the owner-prioritized backlog. `rework-direction-skills-onto-topics` remains deliberately deferred and was not built; a release is a separate owner decision, not part of this migration."
next_prompt: "Resume from synced `main`. The topics migration is complete in #506: `topic:` is the only direction-grouping field, Vision directions are generated by consolidate from shipped topic standings, and the retired direction-skill suite and vision branches must not be restored. Read the current backlog before selecting any follow-up; keep `rework-direction-skills-onto-topics` deferred unless the owner reopens it."
execution_recommendation: "continue-as-is — no delegated plan is active; choose execution mode from the next owner-selected card."
