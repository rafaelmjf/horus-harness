---
status: active
current_focus: "2026-08-01 — PR #482 adds the long-running-service verification bar to the shared managed guidance: active/running plus the expected journal or health signal."
next_action: "Review PR #482 (`auto/verify-guidance-high`, head 45b5764), which carries the v18 managed-block source and its aligned AGENTS.md/CLAUDE.md projections. The card remains deferred/open until the PR has merge provenance."
next_prompt: "Resume horus-harness; fetch first. PR #482 is open from `auto/verify-guidance-high` at 45b5764. Its only product change is the shared runtime-gate guidance, sourced in `horus/templates.py` and projected to AGENTS.md plus CLAUDE.md; bundled skills are unchanged. The required local suite passed (2470 passed, 1 xfailed)."
